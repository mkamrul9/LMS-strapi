...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Learning courses created by Instructors or Content Managers';
    displayName: 'Course';
    pluralName: 'courses';
    singularName: 'course';
  };
...
export interface ApiProgressProgress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    isCompleted: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    quizSubmissions: Schema.Attribute.Relation<
      'oneToMany',
      'api::quiz-submission.quiz-submission'
    >;
    updatedAt: Schema.Attribute.DateTime;
