      ...
      <div className="space-y-8 max-w-7xl mx-auto">
        ...
        <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200 shadow-xs flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <h1 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">All Blog Posts</h1>
            <p className="text-slate-500 text-sm">View and manage all blog posts across the platform.</p>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-3xl border border-dashed border-slate-300 p-12 text-center space-y-4">
            ...
            <p className="text-xs text-slate-500 max-w-sm mx-auto">No articles have been published yet.</p>
          </div>
        ) : (
              ...
              <table className="w-full text-left border-collapse text-sm">
                ...
                <tbody className="divide-y divide-slate-100">
                  {blogs.map((blog) => {
                    ...
                    const updatedAt = blog.updatedAt || blog.attributes?.updatedAt || blog.createdAt;
